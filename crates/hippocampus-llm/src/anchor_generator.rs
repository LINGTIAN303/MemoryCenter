...
//!
//! 基于 [`hippocampus_core::generate::AnchorGenerator`] trait 的 HTTP 实现，
...
use hippocampus_core::generate::{AnchorGenerator, LlmGeneratorConfig};
...
impl AnchorGenerator for HttpAnchorGenerator {
    async fn generate_anchors(&self, file: &MemoryFile) -> hippocampus_core::Result<Vec<String>> {
