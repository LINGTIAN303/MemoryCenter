//! # LocalStorage 实现
//!
//! 本地文件树存储后端。Storage trait 定义在 MemoryCenter-core-logic crate。
//!
//! ## 设计
//!
...
use dashmap::DashMap;
// 重导出 Storage trait 和 SessionMeta，让其他模块可通过 `crate::storage::Storage` 访问
pub use memory_center_core_logic::storage::{SessionMeta, Storage};
