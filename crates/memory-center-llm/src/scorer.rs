//! # LLM 评分器实现
//!
//! 基于 [`memory_center_core::score::AsyncScorer`] trait 的 HTTP 实现，
...
use memory_center_core::score::{AsyncScorer, LlmScorerConfig};
...
impl AsyncScorer for HttpLlmScorer {
    async fn score(&self, file: &MemoryFile) -> memory_center_core::Result<f64> {
